...
import 'package:jasmeen/pages/personal_growth/growth_content.dart';
...
class PersonalGrowthPage extends StatelessWidget {
  const PersonalGrowthPage({super.key});
        ...
        child: Column(
          children: [
           const JHeadBar(),
            ...
            const Center(child: Text('PERSONAL GROWTH',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 25),)),
            const SizedBox(
              height: 60,
            ),
